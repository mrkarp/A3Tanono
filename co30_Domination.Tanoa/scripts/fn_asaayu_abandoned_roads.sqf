//#define __DEBUG__
#define THIS_FILE "fn_asaayu_abandoned_roads.sqf"
#include "..\x_setup.sqf"

params [["_per1", 13], ["_per2", 5], ["_per3", 2], ["_blacklistArea",[]], ["_trg_center", nil], ["_fillRadius", 250]];
...
private _roads = _trg_center nearRoads _fillRadius;
