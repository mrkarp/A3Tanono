...
//#define __DEBUG__
#define THIS_FILE "fn_event_sideprisoners_execution.sqf"
#include "..\..\x_setup.sqf"
...
//position the event site near target center at max distance 150m and min 75m 
private _poss = [[[_target_center, 150]],[[_target_center, 75]]] call BIS_fnc_randomPos;
_x_mt_event_ar = [];

private _trigger = [_poss, [60,60,0,false], [d_own_side,"PRESENT",true], ["this","thisTrigger setVariable ['d_event_start', true]",""]] call d_fnc_CreateTriggerLocal;
